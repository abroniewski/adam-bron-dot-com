...
# Weekly Goals
1. Huddly - Map out roadmap, technical implementation and IP
2. WAGO - Close out project with demo video and documented approach
3. Konekti - Draft 30/60/90 day plan
...
- ~~provide Jason with feedback~~
- ~~confirm debt to Beata~~
- ~~send message to railway to get billing email changed~~
- Draft map of Huddly IP and tech implementation
- Record a video demo of WAGO and document completed items
