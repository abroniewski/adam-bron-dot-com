...
- **Backend:** Node.js (Express.js) or Firebase (for content aggregation and API fetching)
- **Database:** PostgreSQL or Firebase Firestore (for metadata storage)
- **Hosting:** Vercel / Netlify for frontend, Firebase / DigitalOcean for backend
