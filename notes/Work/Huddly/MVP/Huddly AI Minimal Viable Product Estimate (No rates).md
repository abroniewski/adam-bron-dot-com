...
The development timeline is estimated at **12–18 weeks**, with a total project effort of **521–756 hours**. Based on a blended hourly rate of €XX and including a 20% contingency, the total project cost is estimated between **$ XX–$ XX CAD**. For a fixed-cost contract, the high-end estimate of **$XX CAD** will be used.
...
For completeness of the estimate, the hours of a front-end developer are included in the estimate, with an assumed hourly rate of €XX/hour. Huddly AI has indicated a front-end developer will be provided for the duration of the project. All costs for infrastructure and cloud resources will be borne by client. Monthly cost is estimate to be ±$250/month.

For a fixed cost contract, the project will use the high end estimate: $XX
...
- Initial Payment: 50% ($XX CAD) upon project commencement 
- Milestone Payment: 25% ($XX CAD) at 75% completion milestone 
- Final Payment: 25% ($XX CAD) upon final delivery and acceptance 
